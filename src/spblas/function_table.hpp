...
typedef struct {
  ...
  void (*sset_csr_data_i4_usm)(oneapi::mkl::sparse::matrix_handle_t  handle,
  ...
  void (*sset_csr_data_i8_usm)(oneapi::mkl::sparse::matrix_handle_t  handle,
  ...
  void (*dset_csr_data_i4_usm)(oneapi::mkl::sparse::matrix_handle_t  handle,
                             const std::int32_t num_rows,
                             const std::int32_t num_cols,
                             oneapi::mkl::index_base index,
                             std::int32_t *row_ptr,
  ...
  void (*dset_csr_data_i8_usm)(oneapi::mkl::sparse::matrix_handle_t  handle,
                             const std::int64_t num_rows,
                             const std::int64_t num_cols,
                             oneapi::mkl::index_base index,
                             std::int64_t *row_ptr,
  ...
  void (*cset_csr_data_i4_usm)(oneapi::mkl::sparse::matrix_handle_t  handle,
                             const std::int32_t num_rows,
                             const std::int32_t num_cols,
                             oneapi::mkl::index_base index,
                             std::int32_t *row_ptr,
  ...
  void (*cset_csr_data_i8_usm)(oneapi::mkl::sparse::matrix_handle_t  handle,
                             const std::int64_t num_rows,
                             const std::int64_t num_cols,
                             oneapi::mkl::index_base index,
                             std::int64_t *row_ptr,
  ...
  void (*zset_csr_data_i4_usm)(oneapi::mkl::sparse::matrix_handle_t  handle,
                             const std::int32_t num_rows,
                             const std::int32_t num_cols,
                             oneapi::mkl::index_base index,
                             std::int32_t *row_ptr,
  ...
  void (*zset_csr_data_i8_usm)(oneapi::mkl::sparse::matrix_handle_t  handle,
                             const std::int64_t num_rows,
                             const std::int64_t num_cols,
                             index_base index,
                             std::int64_t *row_ptr,
