...
static inline void init_matrix_handle(backend_selector<backend::BACKEND>   selector,
                                      oneapi::mkl::sparse::matrix_handle_t *A) {
  oneapi::mkl::sparse::BACKEND::init_matrix_handle(selector.get_queue(),
                                                   A);
}

static inline void release_matrix_handle(backend_selector<backend::BACKEND>   selector,
                                         oneapi::mkl::sparse::matrix_handle_t *A,
                                         const std::vector<sycl::event>       &dependencies) {
  oneapi::mkl::sparse::BACKEND::release_matrix_handle(selector.get_queue(),
                                                      A, dependencies);
}

// Buffer APIs

static inline void set_csr_data(backend_selector<backend::BACKEND>   selector,
                                oneapi::mkl::sparse::matrix_handle_t A,
  ...
  oneapi::mkl::sparse::BACKEND::set_csr_data(selector.get_queue(),
                                             A, num_rows, num_cols, index_base, row_ptr, col_ind, val);
}
