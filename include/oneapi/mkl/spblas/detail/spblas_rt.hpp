...
namespace sparse {
  ...
  static inline void init_matrix_handle(sycl::queue                          &queue,
                                        oneapi::mkl::sparse::matrix_handle_t *A) {
    detail::init_matrix_handle(get_device_id(queue), queue, A);
  }

  static inline void release_matrix_handle(sycl::queue                          &queue,
                                           oneapi::mkl::sparse::matrix_handle_t *A,
                                           const std::vector<sycl::event>       &dependencies) {
    detail::release_matrix_handle(get_device_id(queue), queue, A, dependencies);
  }

  static inline void set_csr_data(sycl::queue                          &queue,
                                  oneapi::mkl::sparse::matrix_handle_t A,
    ...
    detail::set_csr_data(get_device_id(queue), queue, A, num_rows, num_cols, index, row_ptr, col_ind, val);
  }
